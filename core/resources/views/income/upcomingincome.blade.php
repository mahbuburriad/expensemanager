                ...
                <div class="card">
                    <div class="header">
						<div class="row">
							...
							<div class="pull-right"><a href="#" class="btn btn-sm btn-fill btn-info" data-toggle="modal" data-target="#imports"><i class="ti-plus"></i> <?php echo trans('lang.add_new_income');?></a></div>
							</div>
						</div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo trans('lang.add_new_upcoming_income');?></h4>
        </div>
 ...
 <div class="modal fade" id="pay" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><?php echo trans('lang.receive_income');?></h4>
        </div>
        <div class="modal-body">
    ...
    <form action="" method="POST">
      <div class="row">
         <div class="form-group col-lg-12">
                  ...
                  <select id="incomeaccount" class="form-control" required="true">
